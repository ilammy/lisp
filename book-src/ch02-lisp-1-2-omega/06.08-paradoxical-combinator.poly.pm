...
есть такая область определения, на которой значения всех функций совпадают:
...
Функциональные языки, тоже особо не~жалуют подобный подход, по мнению ◊cite{pj87},
