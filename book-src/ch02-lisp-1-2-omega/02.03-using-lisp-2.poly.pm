...
◊subsection[#:label "lisp1-2-omega/lisp2/ssect:using" #:alt "Используем Lisp-2"]{Используем ◊Lisp-2}

Чтобы полностью определить наш ◊Lisp-2, остаётся указать начальное функциональное окружение
