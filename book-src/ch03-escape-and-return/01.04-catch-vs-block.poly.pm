...
С~одной стороны, ◊ic{catch} и ◊ic{block} похожи:
...
хотя чаще всего это тоже можно легко проверить по исходному коду.
...
в~частности список, собранный специально для этого случая:
...
Правда, для этого используется имя ◊ic{label}, что может быть неожиданным.
