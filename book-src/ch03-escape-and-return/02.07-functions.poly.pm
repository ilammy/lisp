...
где с~помощью ◊ic{argument-cont} последовательно вычисляются все аргументы,
перемежаясь продолжениями ◊ic{gather-cont}, которые собирают список значений аргументов.
