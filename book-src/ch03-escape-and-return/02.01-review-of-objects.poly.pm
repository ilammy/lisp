...
Уж~очень хорошо понятие записей активаций укладывается в~концепцию объектов с~полями.
...
Для нас важнейшей возможностью объектно-ориентированного программирования является
