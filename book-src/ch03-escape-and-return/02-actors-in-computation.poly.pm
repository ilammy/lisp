...
◊; TODO: неудачное название, игра слов с "актёерами" потерялась
...
Обычно продолжения представляются в~виде стековых кадров или записей активаций,
поэтому мы будем использовать объекты для реализации интерпретатора.
