...
Конкатенацию последовательностей будем обозначать знаком~◊${\S}.
Извлечение ◊${i}-го элемента последовательности будем обозначать ◊${\langle{◊|e|_1, ◊|e|_2, \dots, ◊|e|_n}\rangle \downarrow i}
(получая~◊${◊|e|_i}).
Отбрасывание первых ◊${i}~элементов последовательности — ◊${\langle{◊|e|_1, ◊|e|_2, \dots, ◊|e|_n}\rangle \dagger i}
(получая~◊${\langle{◊|e|_{i+1}, \dots, ◊|e|_n}\rangle}).
Длина последовательности~◊${◊|e|^*} записывается~◊${#◊|e|^*}.
...
мы~сходу будем использовать ◊${{} \downarrow 1},~◊${{} \dagger 1},~◊${#}~и~◊${\S}
