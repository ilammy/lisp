...
К~примеру, изначально в~Лиспе планировались ◊nobr{M-выражения} ◊seeCite{mcc60} для записи действий над данными,
...
Как~бы то ни~было, ◊nobr{M-выражения} долго не~протянули, ◊seeCite{mcc78a}
