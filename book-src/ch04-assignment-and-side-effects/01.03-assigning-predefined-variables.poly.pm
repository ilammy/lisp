...
Пользователи вряд~ли ожидают, что одно-единственное присваивание внесёт столько беспорядка.
...
однако, возможно, это затронет какую-нибудь ◊ic{mapc}, которая не~входит в~стандарт.

Глобальные переменные чаще всего переопределяют, чтобы подменить функцию отладочным вариантом,
а~затем исправить обнаруженные недостатки на~месте, в~интерактивной сессии.
