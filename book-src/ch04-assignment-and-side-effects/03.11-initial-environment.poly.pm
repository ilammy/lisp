...
чтобы упростить построение начального окружения и~состояния~памяти.
...
◊noindent
Макрос ◊ic{defprimitive} определяет глобальные примитивные функции.
...
и~наконец упаковывают результат обратно во~внутреннее представление интерпретатора.
