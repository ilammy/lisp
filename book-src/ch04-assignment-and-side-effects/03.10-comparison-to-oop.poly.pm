...
Замыкания, реагирующие на сообщения, с~помощью которых мы представляем значения внутри интерпретатора,
...
Правда, это вовсе не~означает, что замыкания ни~на~что не~способны.
◊seeCite{ar88}
