...
◊indexR{память}
До~сих~пор мы представляли вычисления упорядоченной тройкой из выражения, окружения и~продолжения.
...
К~счастью, реальные компьютеры работают совсем не~так.

◊indexR{присваивание!и побочные эффекты}
◊indexR{побочные эффекты!и присваивание}
Как~мы~уже видели, присваивание переменным можно реализовать с~помощью коробок.
...
Такое определение является не~вполне~точным,◊seeCite{fel90}
...
либо~же принять их такими, какими они есть, и~научиться контролировать возможные последствия.
