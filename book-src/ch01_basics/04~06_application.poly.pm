...
то~такой список означает применение функции,
которое в~◊nobr{◊${\lambda}-исчислении} называется ◊term{аппликацией} или ◊term{комбинацией}.
...
разве что требует явного указания окружения.
