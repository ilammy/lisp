...
◊footnote*{Память (вместе с~подсистемами ввода-вывода) всё ещё остаётся одной из наиболее дорогих частей компьютера, хоть и постоянно дешевеет.}
...
◊footnote*{Некоторые лисп-системы, вроде ◊(CommonLisp),
