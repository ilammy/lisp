...
◊indexR{цитаты}
Специальная форма ◊ic{quote} позволяет записать значение,
которое без цитирования можно было~бы интерпретировать как выражение.
...
программы и данные стали записываться исключительно ◊nobr{S-выражениями}.
