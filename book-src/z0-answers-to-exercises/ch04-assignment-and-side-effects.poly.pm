...
Например, можно хранить промежуточные результаты:
...
Первый вариант в~процессе работы постоянно создаёт и тут~же выбрасывает кучу временных списков.
Ситуацию можно улучшить с~помощью известной оптимизации, называемой ◊term{deforestation}.
◊seeCite{wad88}
...
Исходная версия ◊ic{min-max} гораздо эффективные любого из~них
(ценой богомерзких побочных~эффектов).
...
Суть~в~том, что вычисление альтернативной ветки~$\beta$ производится со~старой памятью~◊ic{s}, а~не~с~новой~◊ic{ss}.
